...
<body>
    ...
    <div class="page-header" style="margin-top:-5%; padding-left: 11%;"><h1>Reporte de Equipos<small></small></h1>      
  </div>
...
<div class="col-md-12"> 
    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%" style="font-size: 10px;" >
        <thead>
        <tr>
            <th>Código</th>
            <th>Cédula</th>
...
<!-- script ajax -->
<script src="dttb/js/con_rep_equ.js"></script>  
