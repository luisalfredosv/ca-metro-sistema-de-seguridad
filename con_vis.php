...
<script src="js/reloj2.js" type="text/javascript" ></script>
<script src="script/con_vis.js" type="text/javascript" ></script>
...
?>  
    ...
    <body onload="mueveReloj()">
      ...
      <div class="page-header" style="margin-top:-5%; padding-left: 11%;">  <h1>Registrar Salida de Visitante  <small></small></h1>
...
<div class="container" >
  <div class="row" >
    <div class="col-lg-3">
      ...
      <input type="text" class="form-control solo-numero" placeholder="Codigo de Visitante" id="res_cod_vis" nombre="res_cod_vis" value="<?php echo $cod_vis; ?>" autofocus>
        <span class="input-group-btn">
          <button class="btn btn-primary" type="button" id="btnBuscar" style="height: 30px;">Buscar</span></button> 
             <button type="button" class="btn btn-default" id="reload" aria-label="Left Align" style="height: 30px;">
        ...
        <h4 style="margin-left: 0.5%;">Datos del visitante</h4>
            ...
            <div class="row">
               <div  class="form-group col-lg-3">
                  ...
                  <div class="cam" id="cam">
                     ...
                     <canvas id="canvas" class="two" name="fichero" width="150" height="122" >
                      ...
                      <img src="" alt="" id="ced_foto" width="" height="" style="padding-left: 40%">
               ...
               <div  class="form-group col-lg-2"> 
                  ...
                  <?php
                     ...
                     echo "<option value=$carnet>- Seleccione -</option>";
                      $sql="SELECT * FROM carnet order by id";
                      //4.- EJECUTAR CONSULTA
                      $resultado=mysql_query($sql);
                      //echo"error:".mysql_error()."<br />\n";
                      while ($filas=mysql_fetch_array($resultado))
               ...
               <div  class="form-group col-lg-3"> 
                  ...
                  <select  name="marca" class="form-control" id="marca" class="marca" disabled> 
                  <?php
                     include ('sql/conectar.php');
                      //3.- ASIGNAR LA VARIABLE SQL EN PARTICULAR
...
<button type="button" id="reg_equ"  class="btn btn-primary" title="Para registrar un equipo al visitante primero registra la visita y luego el botón se activará y podrás realizar el registro de equipos.." disabled>Registrar</button>
               ...
               <div  class="form-group col-lg-4"> 
                  ...
                  <select  name="ent_cnt" class="form-control" id="area"> 
                  <?php
                     include ('sql/conectar.php');
                      //3.- ASIGNAR LA VARIABLE SQL EN PARTICULAR
            ...
            <div class="input-group">        
               ...
               <span class="input-group-btn">          
               <button type="button" class="btn btn-danger" id="btnLimpiarde" style="height: 30px;">Borrar
               </button>      
               </span>    
            </div>
            <?php
           ...
           <label>El visitante entregó el carnet?</label>
          <select  name="ent_cnt" class="form-control" id="ent_cnt"> 
            <?php
                     include ('sql/conectar.php');
                      //3.- ASIGNAR LA VARIABLE SQL EN PARTICULAR
                     echo "<option value=$ent_cnt>- Seleccione -</option>";
                      $sql="SELECT * FROM sel_opc order by id";
                      //4.- EJECUTAR CONSULTA
                      $resultado=mysql_query($sql);
                      //echo"error:".mysql_error()."<br />\n";
                      while ($filas=mysql_fetch_array($resultado))
        ...
        <div class="form-group" align="center">                  
          <div class="btn-group">              
              <button type="button" class="btn btn-default" id="Actualizar" disabled >Actualizar
              </button>            
